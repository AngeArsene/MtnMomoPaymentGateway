...
namespace AngeArsene\MtnMomoPaymentGateway\Utils;
...
final class Helper 
{
    ...
    {
        $env_file_path = Application::$HOME_DIR . DIRECTORY_SEPARATOR . '.env';

        if (!file_exists($env_file_path)) {
            $env_file_path = dirname(Application::$HOME_DIR, 2) . DIRECTORY_SEPARATOR . '.env';
        }
